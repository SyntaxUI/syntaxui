...
const Template = () => {
  ...
  // fetch data from param and match param with TemplateData
        ...
        <div className="flex flex-col items-start justify-center gap-20 px-4 lg:flex-row lg:items-center">
          <div className="flex flex-col items-start justify-center gap-4">
            ...
            <div className="mt-2 max-w-sm text-left text-sm text-gray-600 dark:text-gray-200">
              <p className="">
                Elevate your online presence with a sleek and minimalist
                portfolio that showcases your skills, projects, and thought
                leadership. This modern template offers a clean and professional
                design, empowering you to make a lasting impression on your
                visitors. Discover its powerful features:
              </p>
