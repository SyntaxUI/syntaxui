...
<PreviewCodeTabs
  previewContent={
    <div className="w-full">
      <LineTabs center customID="2" />
    </div>
  }
  codeContent={`
// To center Tabs on the LineTabs component, you need to set the "center" property to "true".
// Example  <LineTabs center />

// Remember to set a unique string as customID when using multiple LineTabs on the same page.
// Example  <LineTabs center customID="AIKO"/>
