...
<div>Component to Showcase the features of your product, app, or service.</div>

<Note>
  I am using Lucide React icon pack, if you want to use some other icon pack you
  can simply replace the icons with the ones you want to use.
</Note>
