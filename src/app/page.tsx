...
import MinimalCenteredFooter from '@/components/Showcase/Footer/MinimalCenteredFooter'
      ...
      <div className="flex h-screen w-full flex-col items-center justify-between text-center">
        ...
        <div className="my-[8rem] flex h-full flex-col items-center justify-center gap-4 px-3">
          <div className="flex w-full flex-col items-center justify-center gap-2">
            <motion.button
              className="relative mb-8 inline-flex items-center gap-2 overflow-hidden rounded-full bg-blue-50 px-3 py-1 text-xs font-medium text-[#5865F2] ring-1 ring-inset ring-blue-700/10"
